    ...
    'profile' => [
        ...
        '2fa' => [
            ...
            'browser_sessions' => [
                ...
                'content' => 'Se necessário, você pode encerrar todas as outras sessões do navegador em todos os seus dispositivos. Algumas de suas sessões recentes estão listadas abaixo; no entanto, esta lista pode não ser completa. Se você acha que sua conta foi comprometida, também deve atualizar sua senha.',
                ...
                'logout_description' => 'Por favor, digite sua senha para confirmar que deseja encerrar suas outras sessões do navegador em todos os seus dispositivos.',
                'logout_action' => 'Encerrar Outras Sessões do Navegador',
